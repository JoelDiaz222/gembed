...
class EmbedStub(object):
    ...
    def __init__(self, channel):
        ...
        self.EmbedBatch = channel.unary_unary(
                ...
                _registered_method=True)
        self.EmbedMultimodal = channel.unary_unary(
                '/tei.v1.Embed/EmbedMultimodal',
                request_serializer=tei__pb2.EmbedMultimodalRequest.SerializeToString,
                response_deserializer=tei__pb2.EmbedBatchResponse.FromString,
                _registered_method=True)
...
class EmbedServicer(object):
    ...
    def EmbedMultimodal(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_EmbedServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'EmbedMultimodal': grpc.unary_unary_rpc_method_handler(
                    servicer.EmbedMultimodal,
                    request_deserializer=tei__pb2.EmbedMultimodalRequest.FromString,
                    response_serializer=tei__pb2.EmbedBatchResponse.SerializeToString,
            ),
    }
...
class Embed(object):
    ...
    def EmbedMultimodal(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tei.v1.Embed/EmbedMultimodal',
            tei__pb2.EmbedMultimodalRequest.SerializeToString,
            tei__pb2.EmbedBatchResponse.FromString,
            options,
            channel_credentials,
            insecure,
